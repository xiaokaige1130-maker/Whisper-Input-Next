...
_STATE_VISUALS = {
    ...
    InputState.RECORDING_AGENT: _StateVisual("🟣", "录音中 (Agent)", "RECORDING"),
    InputState.RECORDING_SMART: _StateVisual("🔴", "录音中 (智能纠错)", "RECORDING"),
    ...
    InputState.PROCESSING_AGENT: _StateVisual("🟣", "Agent 执行中", "PROCESSING"),
    InputState.PROCESSING_SMART: _StateVisual("🔵", "智能纠错中", "PROCESSING"),
